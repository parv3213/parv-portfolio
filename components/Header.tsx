  ...
  return (
    ...
    >
      <div className="mx-auto flex max-w-7xl items-center justify-between px-3 py-2.5 sm:p-5">
        ...
        <div className="mr-1 flex items-center justify-center space-x-2 sm:mr-4 sm:space-x-4">
          <Link
            href="#contactMe"
            ...
            >
              {theme === "dark" || resolvedTheme === "dark" ? (
                ...
                <svg
                  ...
                  viewBox="0 0 24 24"
                  fill="currentColor"
                  className="h-5 w-5 fill-zinc-400 hover:fill-zinc-100 sm:h-6 sm:w-6"
                >
                ...
                <svg
                  ...
                  viewBox="0 0 24 24"
                  fill="currentColor"
                  className="h-5 w-5 fill-zinc-400 hover:fill-zinc-900 sm:h-6 sm:w-6"
                >
                  <path
                    fillRule="evenodd"
